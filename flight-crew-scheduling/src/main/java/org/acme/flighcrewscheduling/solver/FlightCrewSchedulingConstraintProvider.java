...
public class FlightCrewSchedulingConstraintProvider implements ConstraintProvider {
        ...
        public Constraint[] defineConstraints(ConstraintFactory constraintFactory) {
                return new Constraint[] {requiredSkill(constraintFactory),
        ...
        public Constraint flightConflict(ConstraintFactory constraintFactory) {
                return constraintFactory.forEachUniquePair(FlightAssignment.class,
                                ...
                                overlapping(flightAssignment -> flightAssignment.getFlight()
                                                .getDepartureUTCDateTime(),
                                                flightAssignment -> flightAssignment.getFlight()
        ...
        public Constraint transferBetweenTwoFlights(ConstraintFactory constraintFactory) {
                return constraintFactory.forEach(FlightAssignment.class).join(
                                FlightAssignment.class, equal(FlightAssignment::getEmployee),
                                lessThan(FlightAssignment::getDepartureUTCDateTime),
                                filtering((flightAssignment,
                                                flightAssignment2) -> !flightAssignment.getId()
                                                                .equals(flightAssignment2.getId())))
                                .ifNotExists(FlightAssignment.class, equal(((flightAssignment,
                                                flightAssignment2) -> flightAssignment
                                                                .getEmployee()),
                                                FlightAssignment::getEmployee),
                                                filtering((flightAssignment, flightAssignment2,
                                                                otherFlightAssignment) -> !otherFlightAssignment
                                                                                .getId()
                                                                                .equals(flightAssignment
                                                                                                .getId())
                                                                                && !otherFlightAssignment
                                                                                                .getId()
                                                                                                .equals(flightAssignment2
                                                                                                                .getId())
                                                                                && !otherFlightAssignment
                                                                                                .getDepartureUTCDateTime()
                                                                                                .isBefore(flightAssignment
                                                                                                                .getDepartureUTCDateTime())
                                                                                && otherFlightAssignment
                                                                                                .getDepartureUTCDateTime()
                                                                                                .isBefore(flightAssignment2
                                                                                                                .getDepartureUTCDateTime())))
                                .filter((flightAssignment, flightAssignment2) -> !flightAssignment
                                                .getFlight().getArrivalAirport()
                                                .equals(flightAssignment2.getFlight()
                                                                .getDepartureAirport()))
        ...
        public Constraint firstAssignmentNotDepartingFromHome(ConstraintFactory constraintFactory) {
                return constraintFactory.forEach(Employee.class)
                                ...
                                .ifNotExists(FlightAssignment.class,
                                                equal((employee, flightAssignment) -> employee,
                                                                FlightAssignment::getEmployee),
                                                greaterThan((employee,
                                                                flightAssignment) -> flightAssignment
                                                                                .getDepartureUTCDateTime(),
                                                                FlightAssignment::getDepartureUTCDateTime))
                                .filter((employee, flightAssignment) -> !employee.getHomeAirport()
                                                .equals(flightAssignment.getFlight()
                                                                .getDepartureAirport()))
