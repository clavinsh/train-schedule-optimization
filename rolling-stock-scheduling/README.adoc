= Rolling Stock Scheduling (Java, Quarkus, Maven)

Assign rolling stock to train routes to produce an optimized schedule for train operations.
...
[source, shell]
----
$ docker run -p 8080:8080 --rm $USER/rolling-stock-scheduling:1.0-SNAPSHOT
----
